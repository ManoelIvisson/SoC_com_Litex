//--------------------------------------------------------------------------------
// Auto-generated by LiteX (6d10d8175) on 2025-10-06 11:56:30
//--------------------------------------------------------------------------------
...
/* PRODUTO_ESCALAR Registers */
#define CSR_PRODUTO_ESCALAR_BASE (CSR_BASE + 0x1800L)
#define CSR_PRODUTO_ESCALAR_START_ADDR (CSR_BASE + 0x1800L)
#define CSR_PRODUTO_ESCALAR_START_SIZE 1
#define CSR_PRODUTO_ESCALAR_DONE_ADDR (CSR_BASE + 0x1804L)
#define CSR_PRODUTO_ESCALAR_DONE_SIZE 1
#define CSR_PRODUTO_ESCALAR_RESULT_ADDR (CSR_BASE + 0x1808L)
#define CSR_PRODUTO_ESCALAR_RESULT_SIZE 2

/* PRODUTO_ESCALAR Fields */
...
/* PRODUTO_ESCALAR Access Functions */
static inline uint32_t produto_escalar_start_read(void) {
	return csr_read_simple((CSR_BASE + 0x1800L));
}
static inline void produto_escalar_start_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x1800L));
}
static inline uint32_t produto_escalar_done_read(void) {
	return csr_read_simple((CSR_BASE + 0x1804L));
}
static inline uint64_t produto_escalar_result_read(void) {
